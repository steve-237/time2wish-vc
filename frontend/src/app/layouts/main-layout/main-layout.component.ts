        ...
        <div class="toolbar-actions flex-center gap-sm">
          ...
          <div class="profile-menu-container" style="position: relative;">
            ...
            @if (isProfileMenuOpen()) {
              ...
              <!-- Dropdown Box -->
              <div class="profile-dropdown" style="position: absolute; right: 0; top: calc(100% + 10px); width: 280px; z-index: 100; padding: 8px; border-radius: 16px; display: flex; flex-direction: column; gap: 4px; box-shadow: 0 10px 40px rgba(0,0,0,0.3); background: var(--bg-card) !important; border: 1px solid var(--border-card);">
